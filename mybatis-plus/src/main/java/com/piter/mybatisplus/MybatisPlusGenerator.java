...
public class MybatisPlusGenerator {
    ...
    private static final String MUDULE_NAME = "promote-manager";
    //多张表以逗号分隔,oracle数据库表名必须大写
    private static final String TABLE_NAME = "PROMOTE_ACTIVITY_INFO,PROMOTE_ACTIVITY_SCOPE";
    ...
    public static void main(String[] args) {
        ...
        gc.setDateType(DateType.ONLY_DATE);//时间为java.util.Date
...
//        templateConfig.setMapper(null);
        ...
        mpg.setTemplate(
                ...
                .setController(null)
                .setService(null)
                .setServiceImpl("templates/serviceImpl3.java")
        );
